...
<head>
    ...
    <style>
        ...
        h1:hover {
            color: #2ecc71; /* Consistent hover color */
        }
        ...
        .form-control:focus {
            border-color: #2ecc71; /* Consistent focus color */
        ...
        .alert-warning {
            ...
            align-items: center;
            gap: 0.5rem;
            color: #ff9800; /* Consistent warning color */
        }

        .btn-submit {
            background: linear-gradient(135deg, #2ecc71, #27ae60); /* Consistent button color */
            color: white;
            padding: 12px 30px;
            border: none;
            border-radius: 8px;
        ...
        .form-check-input:checked {
            background-color: #2ecc71; /* Consistent checkbox color */
            border-color: #2ecc71;
        }
    </style>
</head>
...
<div class="container">
    <div class="todo-form-container">
        <h1 class="mb-4 text-center text-primary">
            <i class="fas fa-edit me-2"></i>Update Todo
        </h1>
